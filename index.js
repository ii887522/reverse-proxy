...
createServer({ key: readFileSync(process.argv[constants.serverKeyPathIndex] ?? ''), cert: readFileSync(process.argv[constants.serverCertPathIndex] ?? '') }, express().use(async (request, response) => {
